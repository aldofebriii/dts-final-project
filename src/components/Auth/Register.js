...
const Signup = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        sendRequest({uri: 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDF-CQDTijZSeAZBMLYz-KCA1eHLkqLPVs', method: 'POST', body: JSON.stringify({email: emailValue, password: passwordValue})}, (rawData) => {
